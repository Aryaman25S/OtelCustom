...
otel-collector:
	...
	kubectl apply -f observability/configs.yaml
	kubectl apply -f observability/otel-ds.yaml
	bash ./wait.sh _wait "pod -l name=opentelemetry-collector-agent -n otel2"
...
clean-observability:
	- kubectl delete -f observability/rbac.yaml
	- kubectl delete -f observability/configs.yaml
	- kubectl delete -f observability/otel-ds.yaml
	...
	- kubectl delete namespace otel2
